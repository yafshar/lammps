        ...
        for (int j = 0; j < sim_lines; ++j) {
          ...
          if (words[0] == "number-atom-types") {
            if (input->variable->retrieve("kim_natomtypes"))
              error->all(FLERR, "Invalid KIM simulator field, number-atom-types is set before.");
            ...
            if (input->variable->retrieve("kim_nbondtypes"))
              error->all(FLERR, "Invalid KIM simulator field, number-bond-types is set before.");
            ...
            if (input->variable->retrieve("kim_nangletypes"))
              error->all(FLERR, "Invalid KIM simulator field, number-angle-types is set before.");
            ...
            if (input->variable->retrieve("kim_ndihedraltypes"))
              error->all(FLERR, "Invalid KIM simulator field, number-dihedral-types is set before.");
            ...
            if (input->variable->retrieve("kim_nimpropertypes"))
              error->all(FLERR, "Invalid KIM simulator field, number-improper-types is set before.");
